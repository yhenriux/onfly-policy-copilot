...
| Construir grafo | [`app/knowledge_graph/extractor.py`](../app/knowledge_graph/extractor.py) e [`app/knowledge_graph/neo4j_repository.py`](../app/knowledge_graph/neo4j_repository.py) | Extrai fatos auditáveis e grava políticas, regras e evidências no Neo4j. |
